...
public class PacienteDAO {
	...
	public void salvar(Paciente paciente) {
		...
		this.hashMb.addPaciente(paciente.getId_pessoa(), paciente);
	}
	 ...
	 * 
	 * if (matricula != null) jpql = jpql + "  where p.matricula like :matricula";
	 * 
	 * if (nome != null) { jpql = jpql + "where" + " p.nome = :nome";
	 * 
	 * }
	 * 
	 * jpql = jpql + "  order by p.nome";
	 * 
	 * TypedQuery<Paciente> comando = this.getEntityManager().createQuery(jpql,
	 * Paciente.class);
	 * 

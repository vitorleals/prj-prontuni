...
public class PersistenceProperties {
	...
	/**
	 * Procura por propriedades que irão sobrescrever o persistence.xml. A procura é
	 * feita na pasta home do usuário, em variáveis de ambiente e em propriedades
	 * passadas na inicialização do processo Java.
	 * 
	...
	public Properties get() {
		try {
			...
			// Se esse método (systemEnv) retornar alguma propriedade, igual a que o método
			// anterior
			// tenha configurado, ela irá prevalecer.
			props.putAll(systemEnv()); // Heroku

			// Se esse método (javaPropertyJdbcFile()) retornar alguma propriedade, igual a
			// que o método anterior
			// tenha configurado, ela irá prevalecer.
			props.putAll(javaPropertyJdbcFile());

			// Se esse método (javaProperties()) retornar alguma propriedade, igual a que o
			// método anterior
			// tenha configurado, ela irá prevalecer.
	...
	/**
	 * Verifica a existência de um arquivo jdbc.properties na pasta home do usuário.
	 * Caso exista, ele irá ler as propriedades que estão dentro dele.
	 * 
	 ...
	 * 
	 * A variável de ambiente para url, usuário e senha devem ter o mesmo nome dos
	 * valores das propriedades estáticas {@link #JDBC_URL}, {@link #JDBC_USER} e
	 ...
	 * aplicação. Esse parâmetro deve se chamar "jdbc-file", portanto será passado
	 ...
	 * {@link #JDBC_PASSWORD} respectivamente.
	 * 
	 * Caso queira sobrescrever a url, por exemplo, a propriedade a ser passada será
